<div>
    <div class="container max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
        <div class="flex flex-row mb-8">
            <div>
                <a href="{{ route('admin.permissions_create') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded-md w-full focus:outline-none">Criar nova Permissão</a>
            </div>
        </div>
            ...
            <div class="flex flex-col w-full sm:w-auto px-3 py-2 divide-y divide-light-blue-400">
                @forelse ($permissions as $permission)
                    ...
                    <div class="grid grid-cols-4">
                        <div class="col-span-3 py-2 px-2 font-bold">{{ $permission->name }}</div>
                ...
                @empty
                    <div class="grid grid-cols-4">
                        <div class="col-span-3 py-2 px-2 font-bold">Nenhum registro de permissão criado.</div>
